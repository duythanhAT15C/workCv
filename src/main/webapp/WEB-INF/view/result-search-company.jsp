								...
								<div class="block-27">
									<ul>
										...
										<c:if test="${numberPage > 0}">
											<li><a
												href="${pageContext.request.contextPath}/company/search?page=${numberPage - 1}&keySearch=${keySearch}">&lt;</a>
											</li>
										</c:if>
										...
										<c:forEach begin="0" end="${list.totalPages - 1}"
											...
											<c:if test="${pageIndex < list.totalPages}">
												<li class="${numberPage == pageIndex ? 'active' : ''}">
													<a
													href="${pageContext.request.contextPath}/company/search?page=${pageIndex}&keySearch=${keySearch}">
														${pageIndex + 1} </a>
												</li>
											</c:if>
										</c:forEach>
