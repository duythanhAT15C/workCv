	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid px-md-4">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul
					class="navbar-nav ml-auto <security:authorize access="hasRole('ROLE_CANDIDATE')">candidate</security:authorize> <security:authorize access="hasRole('ROLE_COMPANY')">company</security:authorize> <security:authorize access="isAnonymous()">anonymous</security:authorize>">
					<li class="nav-item"><a
					...
					<c:if test="${currentUser.fullName == null}">
						<li class="nav-item cta cta-colored button-login"><a
									...
									<div class="block-18">
										<div class="text d-flex">
											...
											<div class="desc text-left">
												<strong class="number" data-number="${numberCandidate}"></strong>
					...
					<div class="col-md-3 ">
						<ul class="category text-center">
							...
							<li><a style="text-decoration: none !important;"
								href="${pageContext.request.contextPath}/recruitment/category/${categorie.id}">
									<p>${categorie.name}</p> <span class="number"
									data-number="${categorie.numberChoose}"></span> <span>Vị
										trí</span><i class="ion-ios-arrow-forward"></i>
							</a></li>
						</ul>
					</div>
				</c:forEach>
							...
							<div class="col-md-12 ">
								<div
									...
									<c:if test="${not empty user}">
										<div
											class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0 button-aplly-job-home">
				...
				<div class="col-lg-3 sidebar">
					...
					<c:forEach var="company" items="${companies }">
						<div class="sidebar-box">
							<div class="">
								<a
									href="${pageContext.request.contextPath}/company/detail-company/${company.company.id}"
									class="company-wrap"><img
									src="${pageContext.request.contextPath}${company.company.logo }"
									class="img-fluid" alt="Colorlib Free Template"></a>
								<div class="text p-3">
									<h3>
										<a
											href="${pageContext.request.contextPath}/company/detail-company/${company.company.id}">${company.company.nameCompany}</a>
									</h3>
									<p>
										<span class="number" data-number="${company.applicationCount}"
											style="color: black">${company.applicationCount}</span> <span>Vị
											trí ứng tuyển</span>
									</p>
								</div>
							</div>
