...
<body>
	...
	<c:if test="${not empty postJobSuccess}">
	...
	<c:if test="${not empty postJobFalse}">
		<div class="toast" data-delay="1000"
			style="position: fixed; top: 100px; left: 40px; z-index: 2000; width: 300px">
			<script>
				setTimeout(function() {
			...
			<section class="site-section">
				<div class="container">
					<form:form
						...
						method="post" modelAttribute="addNewJob">
								...
								<div class="p-4 p-md-5 border rounded" method="post">
									...
									<div class="form-group">
										<label for="job-location">Hạn ứng tuyển</label> <input
											...
											name="deadline" placeholder="Địa chỉ công ty">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="job-region">Loại công việc</label> <select
											...
											<option value="" disabled selected>Chọn loại công
												việc</option>
